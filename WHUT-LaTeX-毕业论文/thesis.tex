...
%==================== 数学符号公式 ============
\usepackage{xeCJK}
\newcommand{\zhongsong}{\CJKfontspec{华文中宋}}%华文中宋，请自行下载字体并安装，本科2024年，可以用宋体即可，在Fonts文件夹查看自己电脑中宋体字体的名字，修改成一样的。
\usepackage{fontspec}
...
\usepackage{enumitem}				%这个宏包可以调整有序列表的形式，一般使用小括号加阿拉伯数字
\usepackage{lettrine}                % 首字下沉，命令\lettrine
\usepackage{gbt7714}                 %配置gb7714引用格式
\usepackage{float}					%插入浮动图片
...
%==================== 修改链接颜色==================
\usepackage{hyperref} %这个宏包可以修改该链接的颜色
\hypersetup{
	colorlinks=true,
	linkcolor=black,
	filecolor=black,      
